...
const shareImage = 'https://raw.githubusercontent.com/Kingsly-j/cargoXpress/main/public/corgoxpress-logo.png';
...
for(const file of [...await files('src'),...await files('public/site'),'README.md','scripts/verify-cloud.mjs','scripts/check-shipment-history.mjs']) {
  ...
  content=content.replaceAll('Shipwave Global Logistics | Track Shipments Worldwide','corgoXpress | Worldwide Shipping &amp; Tracking')
    ...
    .replaceAll('/shipwave-logo.png','/corgoxpress-logo.png')
    .replaceAll('/cargoxpress-logo.png','/corgoxpress-logo.png')
    .replaceAll('cargoxpress-social.png','corgoxpress-logo.png')
    .replaceAll('og:image:width" content="1200"','og:image:width" content="1774"')
    .replaceAll('og:image:height" content="630"','og:image:height" content="887"')
    .replaceAll('og:image:width" content="1408"','og:image:width" content="1774"')
    .replaceAll('og:image:height" content="768"','og:image:height" content="887"')
    .replaceAll('/shipwave-mark.png','/cargoxpress-mark.png')
    .replaceAll('support@shipwave.com','corgoxpress@gmail.com')
    .replaceAll('contact@iwebbtech.com','corgoxpress@gmail.com')
    .replaceAll('cargoxpress83@gmail.com','corgoxpress@gmail.com')
    .replaceAll('cargoxpress@gmail.com','corgoxpress@gmail.com')
