...
export default function SiteHeader() {
  ...
  return <header className="revolve-header">
    <div className="revolve-top"><span>Welcome to corgoXpress</span><div className="revolve-contact"><a href="tel:+17064521895">+1 (706) 452-1895</a><a href="mailto:corgoxpress@gmail.com">corgoxpress@gmail.com</a><span>Mon - Fri: 09:00 - 05:00</span></div></div>
    <div className="revolve-nav">
      <Link className="revolve-logo" href="/" aria-label="corgoXpress home">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/corgoxpress-logo.png" alt="corgoXpress global logistics" />
      </Link>
