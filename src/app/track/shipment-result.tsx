...
export default function ShipmentResult({shipment}:{shipment:Shipment}) {
  ...
  return localize(<div className="tracking-result" aria-label="Shipment details">
    <section className="tracking-surface tracking-photo-section" aria-label="Shipment image">
      <div className="tracking-photo">{shipment.photoUrl ? <>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src={shipment.photoUrl} alt="Shipment cargo"/>
      </>:<div><Icon name="box-open"/><p>No parcel photo provided</p></div>}</div>
    </section>
    ...
    <section className="tracking-surface"><h2 className="tracking-section-title"><Icon name="th"/>Parcel Information</h2><div className="tracking-parcel"><div><dl className="tracking-parcel-grid">{[
